...
class GoogleCloudFolderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] bucket_name: The name of the Google Cloud Storage bucket to sync to (e.g., `my-bucket` in `gs://my-bucket`). Required.
...
@pulumi.type_token("synced-folder:index:GoogleCloudFolder")
