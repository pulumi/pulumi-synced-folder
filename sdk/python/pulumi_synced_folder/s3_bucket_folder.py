...
class S3BucketFolderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] acl: The AWS [Canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/userguide/acl-overview.html#canned-acl) to apply to each file (e.g., `public-read`). Required.
        :param pulumi.Input[_builtins.str] bucket_name: The name of the S3 bucket to sync to (e.g., `my-bucket` in `s3://my-bucket`). Required.
...
@pulumi.type_token("synced-folder:index:S3BucketFolder")
